...
def dump_to_yaml_file(data: dict, file_path: str, log=DEFAULT_LOG) -> bool:
...
def init_config_with_default(config: dict, default_config: dict) -> dict:
...
def check_key_existence_in_dict(dic: dict, key: Any) -> bool:
    try:
        _ = dic[key]
        return True
    except KeyError:
