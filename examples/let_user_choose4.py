...
LOG_FILE = os.path.join("logs", f"example:let_user_choose4.log")
...
def main():
    ...
    def handler_fruit_choice(choice: str, update: Update, context: CallbackContext) -> USERSTATE:
        ...
        # We have to manually answer the CallbackQuery here
        # since we set answer_callback_query=False (line #85)
        # in this case, we are deleting the previous message
        # (default behavior is a "💭 Loading..." transition message)
    ...
    def handler_shape_choice(choice: str, update: Update, context: CallbackContext) -> USERSTATE:
        ...
        query = update.callback_query
        # We have to manually answer the CallbackQuery here
        # since we set answer_callback_query=False (line #127)
        # in this case, we are deleting the previous message
        # (default behavior is a "💭 Loading..." transition message)
        query.answer(keep_message="")
